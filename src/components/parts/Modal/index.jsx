  ...
  return (
    <>
      <label className="form-control w-full">
        ...
        <input
          className={`input input-border-custom placeholder-secondary text-secondary ${className || ''}`}
          type={type}
          name={name}
          value={value}
          onChange={onChange} 
    ...
    <>
      <label className="form-control w-full">
        ...
        <input
          ...
          // className={`file-input file-input-bordered placeholder-secondary border-secondary text-secondary file:border-secondary file:bg-tertiary file:text-primary focus:border-secondary focus:outline  focus:outline-offset-1 ${className || ''}`}
          type="file"
          name={name}
          value={value}
          onChange={onChange} 
