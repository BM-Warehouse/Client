    ...
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="btn btn-circle btn-ghost">
        <div className="indicator">
          ...
          <span className="badge indicator-item badge-sm text-tertiary">
            {cart ? cart.ProductCart.length : '0'}
          </span>
        </div>
      </div>
      <div
      ...
      >
        <div className="card-body">
          <span className="text-lg font-bold text-tertiary">
            <span>{cart ? cart.ProductCart.length : '0'}</span> Items
          </span>
          <span className="text-info">
            Subtotal: {cart ? formatRupiah(cart.totalPrice) : formatRupiah(0)}
          </span>
