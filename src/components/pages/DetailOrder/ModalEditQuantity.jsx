...
const ModalEditQuantity = ({ checkoutId }) => {
  ...
  const handleSubmit = () => {
    ...
    editProductInCheckout(checkoutId, selectedProduct.id, quantity)
      .then(() => {
      ...
      <dialog id={modalId} className="modal">
        <div className="modal-box h-auto w-auto max-w-full ">
          <div className='flex flex-col items-center'>
            ...
            <div>
              <label htmlFor="" className='mr-4'>Quantity</label>
              <input
                type="number"
                value={quantity}
            ...
            <div className="flex items-center justify-between mt-4">
              <ButtonPrimary icon="edit" onClick={handleSubmit}>Submit</ButtonPrimary>
              <ButtonStrong icon="cancel" onClick={handleCancel}>Cancel</ButtonStrong>
            </div>
          </div>
